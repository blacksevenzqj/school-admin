$(function () {
    $("#jqGrid").jqGrid({
        url: baseBusinessURL + 'visa/material/list',
        datatype: "json",
        colModel: [
    ...
    methods: {
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseBusinessURL + "visa/material/del",
        ...
        saveOrUpdate: function () {
            var url = vm.material.id == null ? "visa/material/save" : "visa/material/update";
            $.ajax({
                type: "POST",
        ...
        getMaterial: function(id){
            $.get(baseBusinessURL + "visa/material/info/" + id, function(r){
